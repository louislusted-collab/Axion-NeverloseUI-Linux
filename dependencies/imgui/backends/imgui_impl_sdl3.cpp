...
#define IMGUI_IMPL_SDL3_HAS_SYSWM 1
#else
#define IMGUI_IMPL_SDL3_HAS_SYSWM 0
#endif
...
{
    // Gamepad mapping disabled on this build to avoid SDL version symbol mismatches.
    // If you need gamepad support, re-enable and map to your SDL headers' enums.
    (void)ImGui::GetIO();
    return;
#if 0
