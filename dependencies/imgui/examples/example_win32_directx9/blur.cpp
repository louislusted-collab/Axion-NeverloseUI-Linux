#ifdef _WIN32
// ============================================================================
// WINDOWS ONLY DIRECTX 9 BLUR IMPLEMENTATION
// ============================================================================
#include "blur.hpp"
...
// LINUX FALLBACK STUB
// ============================================================================
#include "../imgui.h" // Ensures ImDrawList type remains visible to compiler
...
void draw_blur( ImDrawList* drawList ) {
    // Linux fallback: Empty stub function so it compiles without rendering DX9 errors
    (void)drawList;
}
#endif
